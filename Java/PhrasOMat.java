public class PhrasOMat {
    public static void main (String[] args) {
        String[] wortListeEins = {"verlässliche","erfolgsorientierte","webbasierte","allumfassende","clevere","kundenorientierte",
        ...
        String[] wortListeZwei = {"gepowerte","haftende","Mehrwert-","zentrierte","geclusterte","proaktive","Out-of-the-Box-",
                                  "positionierte","vernetzte","fokkusierte","kraftvolle","geordnete","geteilte","kooperative",
