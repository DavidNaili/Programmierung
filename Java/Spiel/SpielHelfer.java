...
public class SpielHelfer {
    ...
    public ArrayList<String> platziereDotCom(int dotComGröße) {
        ...
        if ((dotComAnzahl % 2) == 1) {                  // wenn ungerades Dot-Com (vertikal platzieren)
        ...
        while ( !erfolg & versuche++ < 200) {           // Haupt-Suchschleife
            ...
            //System.out.print(" Versuche " + ort);     // Testen / Cheaten
            ...
            while (erfolg && x < dotComGröße) {         // nach angrenzenden freien Orten suchen
              if (raster[ort] == 0) {                   // wenn noch nicht benutzt
                ...
                ort += inkrement;                       // 'nächste' angrenzende Zeile versuchen
              ...
              } else {                                  // bereits belegten Ort gefunden
        ...
        while (x < dotComGröße) {
            ...
            spalte = koordinaten[x] % rasterLänge;          // nummerischen Spaltenwert holen
